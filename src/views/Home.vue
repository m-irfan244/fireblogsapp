...
export default {
  ...
  data() {
    return {
      welcomeScreen: {
        title: "Welcome!",
        blogPost: "In times of drastic change, it is the learners who inherit the future. Learners usually find themselves equipped to live in a world that no longer exists.",
        welcomeScreen: true,
        photo: "coding"
      },
      sampleBlogPosts: [
